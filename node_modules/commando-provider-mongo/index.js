const SettingProvider = require('@iceprod/discord.js-commando').SettingProvider;
...
class MongoDBProvider extends SettingProvider {
	...
	async init(client) {
		...
		this.listeners
			...
			.set('groupRegister', group => {
				for(const [guild, settings] of this.settings) {
					if(guild !== 'global' && !(client.guilds.cache.has(guild) || client.guilds.cache.has(guild))) continue;
					this.setupGuildGroup((client.guilds.cache.get(guild) || client.guilds.cache.get(guild)), group, settings);
				}
			});
	...
	setupGuild(guild, settings) {
		...
		guild = (this.client.guilds.cache.get(guild) || this.client.guilds.cache.get(guild)) || null;
